...
import com.msbeigi.request.LogInRequest;
import com.msbeigi.response.AuthResponse;
import com.msbeigi.service.CustomerUserDetailsService;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> createUserHandler(@RequestBody User user) throws Exception {
        ...
        AuthResponse authResponse =
                new AuthResponse(jwt, "Registration Successful.", savedUser.getRole());
    ...
    public ResponseEntity<AuthResponse> signIn(@RequestBody LogInRequest request) {
        ...
        AuthResponse authResponse =
                new AuthResponse(jwt, "Login Successful.", USER_ROLE.valueOf(role));
